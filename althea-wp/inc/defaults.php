<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            return __( '<span style="font-size: 53%; font-weight: 300;">Don\'t wait for the opportunity.</span><br>CREATE IT!',
                'althea-wp' );
        });
        add_filter('colibri_theme_subtitle_default_content', function($subtitle) {
            return __("Start creating your website today.",'althea-wp');
        });
    });


    $althea_wp_theme_svg_icons = array(
		'fort-awesome'  => array(
	...
	$althea_wp_theme_divider_style = array(
	...
	$althea_wp_lorem_ipsum = "Start creating your website today.";;
	...
	return array(
		...
		'lorem_ipsum'                       => $althea_wp_lorem_ipsum,
		...
		'assets_js_key'                     => "altheaFrontendData",
		'default_icon'                      => $althea_wp_theme_svg_icons['fort-awesome'],
		'icons'                             => $althea_wp_theme_svg_icons,
		'divider_style'                     => $althea_wp_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $althea_wp_theme_svg_icons['facebook'],
							'link_value' => 'http://www.facebook.com/',
							'index'      => 0,
						),
						array(
							'icon'       => $althea_wp_theme_svg_icons['twitter'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $althea_wp_theme_svg_icons['youtube'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $althea_wp_theme_svg_icons['vimeo'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $althea_wp_theme_svg_icons['map-marker'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $althea_wp_theme_svg_icons['phone-square'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $althea_wp_theme_svg_icons['envelope'],
